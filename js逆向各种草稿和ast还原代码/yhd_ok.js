    ...
    1: [function (c, d, e) {
      (function (g) {
        ...
        function ak(au) {
          ...
          var b5 = ["ivli:"]["concat"]([ "0:"+account.length,"1:"+password.length])["join"](','); //这里ai得到的是账号信息  [ "0:6","1:6"]  索引和长度
          var b6 = ["iivl:"]["concat"](ap)["join"](',');
          var b7 = ["ivcvj:"]["concat"](aq)["join"](',');
          var b8 = ["scvje:"]["concat"](ar)["join"](',');
          var b9 = ["ewhi:"]["concat"](["0:233-24", "1:233-24", "5:330-52"])["join"](',');  //这里  "ewhi:"]["concat"](aj())["join"](',') aj 返回的是标签的宽和高["0:233-24", "1:233-24", "5:330-52"]  
